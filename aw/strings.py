"""Game string table for Another World.

Maps string IDs (used by opcode 0x12) to text content.
Extracted from the reference implementation (staticres.cpp).
"""

# String table: ID -> text
# Note: } in original represents copyright symbol
STRINGS = {
    ...
    0x04B: "  5",
    0x04C: "  17",
    # Copy protection code wheel passwords
    0x15E: "LDKD",
    0x15F: "HTDC",
    0x160: "CLLD",
    0x161: "FXLC",
    ...
    0x173: "TXHF",
    0x174: "JHJL",
    # Hex digit characters for access code screen
    0x12C: "0",
    0x12D: "1",
    0x12E: "2",
    0x12F: "3",
